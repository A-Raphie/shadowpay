...
// is your Alchemy key (see .env.example) — falls back to Lava public RPC so the
// app runs without a key.
...
export const myFrontendProviders: ProviderInterface[] = [
    ...
    new RpcProvider({ nodeUrl: alchemyKey ? "https://starknet-sepolia.g.alchemy.com/starknet/version/rpc/v0_10/" + alchemyKey : "https://rpc.starknet-sepolia.lava.build" })];
